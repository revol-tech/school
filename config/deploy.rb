...
set :repository, "git@github.com:revol-tech/school.git"
...
role :web, "school.revol-tech.com.np" # Your HTTP server, Apache/etc
role :app, "school.revol-tech.com.np" # This may be the same as your `Web` server
role :db, "school.revol-tech.com.np", :primary => true # This is where Rails migrations will run
